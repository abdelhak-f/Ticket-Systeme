...
class EditTicket extends Component{
  ...
  constructor(props) {
    ...
    this.onChangeTicketDescription = this.onChangeTicketTitle.bind(this);
    this.onChangeTicketType = this.onChangeTicketType.bind(this);
    this.onChangeTicketUrgence = this.onChangeTicketUrgence.bind(this);
  ...
  onSubmit = (e) => {
    ...
    const { title, type, urgence, description, etat, date } = this.state.ticket;

    axios.put('/http://localhost:5000/api/Updateticket/'+this.props.match.params.id, { title, type, urgence, description, etat, date })
      .then((result) => {
	...
	render(){
		return(
			<div className="ticket">
              ...
              name="urgence"
                      value={this.state.ticket.urgence}
                      onChange={this.onChange} 
                      required>
                      {
