...
export default class CreateTicket extends Component {
	constructor(props) {
        ...
        this.onChangeType = this.onChangeDescription.bind(this);
        this.onChangeUrgence = this.onChangeProjectName.bind(this);
        this.onChangDescription = this.onChangeAssignee.bind(this);
        this.onChangeEtat = this.onChangePriority.bind(this);
        this.onChangeDate = this.onChangeStatus.bind(this);
