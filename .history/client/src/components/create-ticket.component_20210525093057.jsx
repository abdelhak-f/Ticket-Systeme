...
const departement = ['Direction', 'Ressources humaines', 'Production '];
                          ...
                          {ticketList.map((value, index) =>{
                            ...
                            <tr key={value.index}>
                               ...
                               className="badge bg-info">
                                 <a href={`/updatticket/:id/${value._id}`}>Edit</a>
                                 </button></td>
                               
                               <td><button className="badge bg-danger"><a to={"/delete/"} >Delete</a></button></td>
