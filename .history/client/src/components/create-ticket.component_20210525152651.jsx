...
function CreateTicket({ setPopup, setCardUser }) {
    ...
    deleteTicket() {
        ...
        axios.delete('http://localhost:5000/deleteTicket/' + this.props.obj._id)
            .then((res) => {
                        ...
                        <tbody>
                          {ticketList.map((value, index) =>{
                            ...
                            <tr key={value.index}>
                               ...
                               <td><button className="badge bg-danger" onClick={this.deleteStudent}><a to={"/delete/"} >Delete</a></button></td>
